...
/**
 * A HorizontalScrollView (HSV) implementation that disallows touch events (so no scrolling can be
 * done by the user).
 * 
 * This HSV MUST contain a single ViewGroup as its only child, and this ViewGroup will be used to
 * display the children Views passed in to the initViews() method.
 */
public class DocphinHorizontalScrollView extends HorizontalScrollView
{
	SizeCallback _callBack;
	MyOnGlobalLayoutListener listener;
	Context context;
    public DocphinHorizontalScrollView(Context context, AttributeSet attrs,
            int defStyle)
    {
    ...
    public DocphinHorizontalScrollView(Context context)
    {
        super(context);
        init(context);
    }
            ...
            SizeCallback sizeCallback)
    {
        ...
        // Add all the children, but add them invisible so that the layouts are calculated, but you
        // can't see the Views
        ...
        _callBack = sizeCallback;
        // Add a layout listener to this HSV
        // This listener is responsible for arranging the child views.
        listener =
                new MyOnGlobalLayoutListener(parent, children, scrollToViewIdx,
                        sizeCallback);
...
//    	int displayWidth = mWinMgr.getDefaultDisplay().getWidth();
		...
		case MotionEvent.ACTION_MOVE:
			if(_callBack.getOffsetWidth() < 100){
				_callBack.setOffsetWidth(10);
				listener.pullMainView();
			}else {
				_callBack.initOffsetWidth();
...
//			listener.pullMainView();
    ...
    /**
     * An OnGlobalLayoutListener impl that passes on the call to onGlobalLayout to a SizeCallback,
     * before removing all the Views in the HSV and adding them again with calculated widths and
     * heights.
     */
    class MyOnGlobalLayoutListener implements OnGlobalLayoutListener
    {
        ...
        public void onGlobalLayout()
        {
            ...
            final HorizontalScrollView me = DocphinHorizontalScrollView.this;
