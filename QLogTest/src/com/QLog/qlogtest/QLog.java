...
public class QLog implements Thread.UncaughtExceptionHandler {
	...
	private static String QLOG_BASE_URL = "http://djangostaging.qburst.com/qlogwebservices/summarylog/";
	private static String QLOG_DETAILED_BASE_URL = "http://djangostaging.qburst.com/qlogwebservices/detailedreport/";
	...
	private static QLogFileManager _qlogManager;
	...
	public static void setupLogging(Application application) {
		...
		app = application;
		_qlogManager = new QLogFileManager();
	...
	public static void d(java.lang.String tag, java.lang.String msg) {
		...
		_qlogManager.saveLog(getContentToFile(tag, msg, SEVERITY_DEBUG));
	...
	public static void w(java.lang.String tag, java.lang.String msg) {
		...
		_qlogManager.saveLog(getContentToFile(tag, msg, SEVERITY_WARNING));
	...
	public static void e(java.lang.String tag, java.lang.String msg) {
		...
		_qlogManager.saveLog(getContentToFile(tag, msg, SEVERITY_ERROR));
	...
	public static void i(java.lang.String tag, java.lang.String msg) {
		...
		_qlogManager.saveLog(getContentToFile(tag, msg, SEVERITY_INFORMATION));
	...
	private static void postLog(String report, String severity,
		...
		try {
			...
			String body = getPostParamsForReport(report,
					severity, isDetailedReport);
			
//			new QLogFileManager().saveLog(getContentToFile(report, severity));
...
//					inputStream, "UTF-8"));
	...
	public static String getContentToFile(String tag, String message, 
			String severity) {
...
//		String datetime = DateFormat.format("dd/MM/yyyy hh:mm:ss GMT", new Date(System.currentTimeMillis())).toString();
		
		String content = datetime + "\t" + severity + "\t" + tag + "\t" + message + "\n";
//	    String content = datetime + severity + tag + message;
