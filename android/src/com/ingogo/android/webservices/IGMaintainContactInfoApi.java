...
public class IGMaintainContactInfoApi extends IGBaseApi implements
		IGApiInterface, IGApiListener {
	IGMaintainContactInfoApiListener _listener;

	public IGMaintainContactInfoApi(
			IGMaintainContactInfoApiListener apiListener,
	...
	public void maintainContactInfo(IGContactInfoModel contactInformation) {
		IGContactInfoRequestBean requestBean = new IGContactInfoRequestBean(
	...
	public void onResponseReceived(Map<String, Object> response) {
		...
		if (response != null
			...
			if (respBean != null) {
				_listener.maintainContactInfoCompleted(respBean
			...
			if (respBean != null) {
				_listener.maintainContactInfoFailed(respBean
	...
	public void onFailedToGetResponse(Map<String, Object> errorResponse) {
		...
		respBean = (IGContactInfoResponseBean) errorResponse
				.get(IGApiConstants.kApiFailedMsgKey);
		if (respBean != null) {
			_listener.maintainContactInfoFailed(respBean.getResponseMessages()
	...
	public String buildURL() {
		...
		String apiUrl = IGApiConstants.kIngogoBaseURL
				+ IGApiConstants.kMaintainContactInfoUrl;
		return apiUrl;
	}
